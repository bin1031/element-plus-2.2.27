...
| select-isolated           | If true, only the single row will be toggled and doesn't matter it's children rows. Only for tree data multiple select.                                                                                                         | boolean                                                                                                                                                              |—                                                   | false
...
| filter-class-name ^(2.5.0) | className for the filter dropdow                                                                                                                                                                                    | string                                             | —                                                                                                                                | —                                 |
